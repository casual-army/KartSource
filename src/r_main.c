...
static CV_PossibleValue_t fov_cons_t[] = {{45*FRACUNIT, "MIN"}, {179*FRACUNIT, "MAX"}, {0, NULL}};
...
consvar_t cv_fov = {"fov", "105", CV_FLOAT|CV_CALL|CV_SAVE, fov_cons_t, Fov_OnChange, 0, NULL, NULL, 0, 0, NULL};
